...
[!] cURL error 18: See http://curl.haxx.se/libcurl/c/libcurl-errors.html
		...
		<header>
			...
			<div class="items">
				...
				<!--
				<div class="item">
					<button class="cmn-toggle-switch cmn-toggle-switch__htx" onclick="slideout.toggle();">
				...
				<div class="item item 2">
					<button class="cmn-toggle-switch cmn-toggle-switch__htla" onclick="slideout.toggle();">
						<span>toggle menu</span>
					</button>
				</div><!-- -->
				<!--
				...
				<!--
				<div class="item">
					<button class="cmn-toggle-switch cmn-toggle-switch__htra" onclick="slideout.toggle();">
						<span>toggle menu</span>
					</button>
				</div><!-- -->
			</div>
